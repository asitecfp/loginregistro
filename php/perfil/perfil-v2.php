...
//INICIO responseKeys INICIO responseKeys INICIO responseKeys INICIO responseKeys INICIO responseKeys INICIO responseKeys 
//INICIO responseKeys INICIO responseKeys INICIO responseKeys INICIO responseKeys INICIO responseKeys INICIO responseKeys 
//INICIO responseKeys INICIO responseKeys INICIO responseKeys INICIO responseKeys INICIO responseKeys INICIO responseKeys 
//INICIO responseKeys INICIO responseKeys INICIO responseKeys INICIO responseKeys INICIO responseKeys INICIO responseKeys 
//INICIO responseKeys INICIO responseKeys INICIO responseKeys INICIO responseKeys INICIO responseKeys INICIO responseKeys 
...
?>
			<script>
				function r() { //location.href="index2 2 1.html" }
				setTimeout ("r()", 6000); 
			</script>
			<div align="center">
				<h2>
...
*/
	  ...
	  ';
	  echo "
	  <META HTTP-EQUIV='REFRESH' CONTENT='5;URL=../perfil_usuario.php?rt=".$ruta_img."&nt=" .$nnombre1." &extn=" .$exten_img."'>
	  ";
...
//responseKeys 333333333333333333333333333333333333333333333333333333333333333333333333
//666666666666666666 responseKeys 66666666666666666666666666666
        } else {
                //echo '<h2>You are spammer ! Get the @$%K out</h2>';
?>
			<script>
				function r() { location.href="perfil-v2.php?nt=<?php echo $id_ficha; ?>" }
				setTimeout ("r()", 6000); 
			</script>
			<div align="center">
				<h2>
                Eres un Spamer
                <br>
                Se devolverá en: <span id="tiempoact" style="color:#03F; font-size:34px; font-weight:bold;"></span> segundos.
                </h2>
			</div>
<?php
        }
}
// FIN responseKeys  FIN responseKeys  FIN responseKeys  FIN responseKeys  FIN responseKeys  FIN responseKeys  FIN responseKeys 
// FIN responseKeys  FIN responseKeys  FIN responseKeys  FIN responseKeys  FIN responseKeys  FIN responseKeys  FIN responseKeys 
// FIN responseKeys  FIN responseKeys  FIN responseKeys  FIN responseKeys  FIN responseKeys  FIN responseKeys  FIN responseKeys 
// FIN responseKeys  FIN responseKeys  FIN responseKeys  FIN responseKeys  FIN responseKeys  FIN responseKeys  FIN responseKeys 
// FIN responseKeys  FIN responseKeys  FIN responseKeys  FIN responseKeys  FIN responseKeys  FIN responseKeys  FIN responseKeys 
...
?>
  <div align="center">
  <form action="perfil-v2.php" enctype="multipart/form-data" method="post">
  <label for="imagen">Imagen:</label> 
  <input id="imagen" name="imagen" size="30" type="file" required="required"/>
  <br>
  ...
  <input name="id_ficha" type="hidden" value="<?php echo $nombre_img_nt; ?>" size="5" readonly="readonly">
    </form>
