								...
								<form action="registro_cont.php" method="POST" enctype="multipart/form-data">
									<div class="mdl-grid">
										<div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--6-col-desktop"><!---->
											...
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<input name="nombre" class="mdl-textfield__input" type="text" maxlength="48" id="NameProduct" require>
												<label class="mdl-textfield__label" for="NameProduct">Nombre</label>
												<span class="mdl-textfield__error">Invalid name</span>
											</div>
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<input name="nombre2" class="mdl-textfield__input" type="text" maxlength="48" id="NameProduct">
												<label class="mdl-textfield__label" for="NameProduct">Nombre 2</label>
												<span class="mdl-textfield__error">Invalid name</span>
											</div>
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<input name="sinopsis" class="mdl-textfield__input" type="text" id="NameProduct">
											...
											<div class="mdl-textfield mdl-js-textfield">
												<select name="genero[]" class="mdl-textfield__input">
													<option value="" disabled="" selected="">Genero del contenido</option>
														<?php
															$mysqli = new mysqli('localhost', 'antonio', '*Lm2638220$', 'bnucleds');
											...
											<div class="mdl-textfield mdl-js-textfield">
												<select name="tipocont[]" class="mdl-textfield__input">
											...
											<div class="mdl-textfield mdl-js-textfield">
												<select name="clasecont[]" class="mdl-textfield__input">
													<option value="" disabled="" selected="">Clase de Contenido</option>
														<?php
														$mysqli = new mysqli('localhost', 'antonio', '*Lm2638220$', 'bnucleds');
											...
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<input name="duracion" class="mdl-textfield__input" type="text" id="DuraCont">
										...
										<div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--6-col-desktop">
											...
											<div class="mdl-textfield mdl-js-textfield">
												<select name="productora[]" class="mdl-textfield__input">
													<option value="" disabled="" selected="">Productora del Contenido</option>
														<?php
															$mysqli = new mysqli('localhost', 'antonio', '*Lm2638220$', 'bnucleds');
         													$query = $mysqli -> query ("SELECT * FROM procon12 ORDER BY nomtip12");
          													while ($valores = mysqli_fetch_array($query)) {
											...
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<select name="calidad[]" class="mdl-textfield__input">
													<option value="" disabled="" selected="">Calidad de Reproduccion</option>
														<?php
															$mysqli = new mysqli('localhost', 'antonio', '*Lm2638220$', 'bnucleds');
											...
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<select name="formato[]" class="mdl-textfield__input">
													<option value="" disabled="" selected="">Formato del Contenido</option>
														<?php
															$mysqli = new mysqli('localhost', 'antonio', '*Lm2638220$', 'bnucleds');
											...
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<select name="estado[]" class="mdl-textfield__input">
													...
													<option value="rev" disabled>Revisión</option>
											...
											<div class="mdl-textfield mdl-js-textfield">
												...
												<input name="FechaPro" type="date" class="mdl-textfield__input" id="Fecha-Pro">
											</div>
											<div class="mdl-textfield mdl-js-textfield">
												<label class="" for="fecha-lan">Fecha Lanzamiento</label>
												<input name="FechaLan" type="date" class="mdl-textfield__input" id="Fecha-Lan">
											</div>
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<label class="" for="NameProduct">Logo del Contenido</label>
													<span class="mdl-textfield__error">Invalid name</span>
													<input name="LogoCon" class="mdl-textfield__input" type="file" pattern="-?[A-Za-z0-9áéíóúÁÉÍÓÚ ]*(\.[0-9]+)?" id="NameLogo" accept="image/x-png" onchange="validateFileType1()">
												...
												<label class="" for="NameProduct">Imagen Principal del Contenido</label>
													<span class="mdl-textfield__error">Invalid name</span>	
													<input name="ImagenCon" class="mdl-textfield__input" type="file" pattern="-?[A-Za-z0-9áéíóúÁÉÍÓÚ ]*(\.[0-9]+)?" id="NameTrailer" accept="image/jpeg" onchange="validateFileType2()">
													<script type="text/javascript">
   														function validateFileType2(){
        													var fileName = document.getElementById("NameTrailer").value;
        													var idxDot = fileName.lastIndexOf(".") + 1;
       														var extFile = fileName.substr(idxDot, fileName.length).toLowerCase();
												...
												<label class="" for="NameProduct">Cover del Contenido</label>
													<span class="mdl-textfield__error">Invalid name</span>	
													<input name="CoverCon" class="mdl-textfield__input" type="file" pattern="-?[A-Za-z0-9áéíóúÁÉÍÓÚ ]*(\.[0-9]+)?" id="NameContenido" accept="image/jpeg" onchange="validateFileType3()">
													<script type="text/javascript">
   														function validateFileType3(){
        													var fileName = document.getElementById("NameContenido").value;
        													var idxDot = fileName.lastIndexOf(".") + 1;
       														var extFile = fileName.substr(idxDot, fileName.length).toLowerCase();
        													if (extFile=="jpg" || extFile=="jpeg"){
            																//TO DO
								...
								<form action="update_cont.php" method="POST" enctype="multipart/form-data">
									<div class="mdl-grid">
										<div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--6-col-desktop"><!---->
											...
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<input name="nombre_UP" class="mdl-textfield__input" type="text" id="NameProduct" value="<?php echo ''.$nombrecont.'';?>" require>
												<label class="mdl-textfield__label" for="NameProduct">Nombre</label>
												<span class="mdl-textfield__error">Invalid name</span>
											</div>
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<input name="nombre2_UP" class="mdl-textfield__input" type="text" id="NameProduct" value="<?php echo ''.$nombrecont2.'';?>">
												<label class="mdl-textfield__label" for="NameProduct">Nombre 2</label>
												<span class="mdl-textfield__error">Invalid name</span>
											</div>
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<input name="sinopsis_UP" class="mdl-textfield__input" type="text" id="NameProduct" value="<?php echo ''.$sinopsiscont.'';?>">
												<label class="mdl-textfield__label" for="NameProduct">Sinopsis</label>
												<span class="mdl-textfield__error">Invalid name</span>
											</div>
											<h5 class="text-condensedLight">Detalles</h5>	
