...
<body>
	...
	<section class="full-width pageContent">
		...
		<div class="mdl-tabs mdl-js-tabs mdl-js-ripple-effect">
											...
											<table  class="mdl-data-table mdl-js-data-table mdl-shadow--2dp full-width table-responsive">
												...
												<?php
													...
													while ($fila = $resultado->fetch_assoc()) {
														...
														echo ' 
															<tr onclick="ob2('.$bot.','.$id.')" class="'.$bot.'btn-temp" id="btn-temp">
                                                                ...
                                                                <td id="" value="'.$bot.'">
                                                                <select id="'.$bot.'num_tempc'.$id.'" name="" class="mdl-textfield__input">
                                                                    <option value="" disabled="" selected="">Temporada del Contenido</option>';
                                                                        
                                                                            $mysqli = new mysqli('localhost', 'antonio', '*Lm2638220$', 'bnucleds');
                                                                            $query = $mysqli -> query ("SELECT * FROM maetem17 WHERE idmaec17 = $id ");
                                                                            
                                                                            while ($valores = mysqli_fetch_array($query)) {
                                                                                
                                                                            echo '<option id="" value="">'.$valores["numtem17"].'</option>';
                                                                            }
                                                                        '
                                                                </select>
                                                                </td>																
			...
			<div class="full-width panel-content">
								<form action="registro_capitulo.php" method="POST" enctype="multipart/form-data">
									<div class="mdl-grid">
										<div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--6-col-desktop"><!---->
											...
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">	
												...
												<label class="mdl-textfield__label" for="BarCode">Código Contenido</label>
												<span class="mdl-textfield__error">Invalid barcode</span>	
											</div>
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<input id="nom_conte" name="nombre_UP" class="mdl-textfield__input" type="text" id="NameProduct" value=" " readonly>
												<label class="mdl-textfield__label" for="NameProduct">Nombre</label>
												<span class="mdl-textfield__error">Invalid name</span>
											</div>
                                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">	
										
												<input id="num_tempecap" name="num_tempecap" class="mdl-textfield__input" type="number" pattern="-?[0-9- ]*(\.[0-9]+)?" id="BarCode" value="0" readonly>
												<label class="mdl-textfield__label" for="BarCode">Número Temporada</label>
												<span class="mdl-textfield__error">Invalid barcode</span>	
											</div>
										...
										<div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--6-col-desktop">
											<h5 class="text-condensedLight">Datos del capítulo</h5>
											<div class="mdl-textfield mdl-js-textfield">
												
												<input id="num_cap" name="num_cap" class="mdl-textfield__input" type="number" pattern="-?[0-9- ]*(\.[0-9]+)?" id="BarCode" value="" require>
												<label class="mdl-textfield__label" for="BarCode">Número</label>
												<span class="mdl-textfield__error">Invalid barcode</span>	
											</div>
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<input id="nom_cap" name="nom_cap" class="mdl-textfield__input" type="text" id="NameProduct" require>
												<label class="mdl-textfield__label" for="NameProduct">Nombre</label>
												<span class="mdl-textfield__error">Invalid name</span>
											</div>
											...
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<input id="des_cap" name="des_cap" class="mdl-textfield__input" type="text" id="NameProduct" require>
												<label class="mdl-textfield__label" for="NameProduct">Descripción</label>
												<span class="mdl-textfield__error">Invalid name</span>
											</div>
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
												<input name="dur_cap" class="mdl-textfield__input" type="text" id="dur_cap">
												<label class="mdl-textfield__label" for="DuraCont">Duración</label>
												<span class="mdl-textfield__error">Invalid name</span>
											</div>
											<div class="mdl-textfield mdl-js-textfield" disabled >
